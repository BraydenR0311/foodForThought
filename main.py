...
from src.managers.gamestatemanager import GameStateManager
from src.managers.tablemanager import TableManager
from src.managers.visualmanager import VisualManager
from src.utils.utils import get_screen_rect, read_tilemap

pg.init()

clock = pg.time.Clock()
gamestatemanager = GameStateManager(StateKey.MAIN_MENU)
...
while gamestatemanager.is_running():
    ...
    pg.display.flip()
    gamemanager.clock.tick(Config.FPS)
